...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132923/Annoyances/sound_car_b6nkw3.jpg")
...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132922/Annoyances/scarymask_jhzhqk.jpg")
...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132922/Annoyances/wingman_x2d3fp.jpg")
...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132924/Annoyances/energy_nvv6r0.jpg")
...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132924/Annoyances/dairyproduct_nzal5n.webp")
...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132922/Annoyances/glitterbomb.jpg_labjrx.webp")
...
file = URI.open("https://res.cloudinary.com/dekzlt7wx/image/upload/v1669132922/Annoyances/nakedguy_xxuhd4.jpg")
